...
const renderImage = (teamName) => {
  switch (teamName) {
    case "Kings XI Punjab":
      return <img src={kings} alt="kings" height={50} width={75} />;
    case "Chennai Super Kings":
      return <img src={csk} alt="csk" height={50} width={200} />;
    case "Delhi Capitals":
      return (
        <img src={Delhi_Capitals} alt="capitals" height={75} width={200} />
      );
    case "Mumbai Indians":
      return <img src={Mumbai_Indians} alt="mumbai" height={75} width={200} />;
    case "Sunrisers Hyderabad":
      return <img src={sunrisers} alt="sunrisers" height={75} width={200} />;
    case "Rajasthan Royals":
      return (
        <img
          src={Rajasthan_Royals}
          alt="Rajasthan_Royals"
          height={75}
          width={200}
        />
      );
    case "Royal Challengers Bangalore":
      return (
        <img
          src={Royal_Challengers}
          alt="Royal_Challengers"
          height={75}
          width={200}
        />
      );
    case "Pune Warriors":
      return (
        <img src={pune_warriors} alt="pune_warriors" height={75} width={200} />
      );
    case "Rising Pune Supergiant":
      return (
        <img
          src={super_giant_pune}
          alt="super_giant_pune"
          height={75}
          width={200}
        />
      );
    case "Kolkata Knight Riders":
      return <img src={KKR} alt="KKR" height={75} width={200} />;
    case "Gujarat Lions":
      return <img src={kochi} alt="KKR" height={75} width={200} />;
    case "Kochi Tuskers Kerala":
      return <img src={GL} alt="KKR" height={75} width={200} />;
    case "Deccan Chargers":
      return <img src={DC} alt="KKR" height={75} width={200} />;
    case "Rising Pune Supergiants":
      return (
        <img src={super_giant_pune} alt="super_gn" height={75} width={200} />
      );
    default:
      return null;
  }
